...
import com.iafnstudios.petclinic.repository.VetRepository;
...
public class VetSpringDataJpaServiceImpl implements VetService {

    private final VetRepository vetRepository;

    public VetSpringDataJpaServiceImpl(VetRepository vetRepository) {
